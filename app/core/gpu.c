...
#define __PYX_HAVE__app__core__gpu
#define __PYX_HAVE_API__app__core__gpu
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "app.core.gpu" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "app.core.gpu"
extern int __pyx_module_is_main_app__core__gpu;
int __pyx_module_is_main_app__core__gpu = 0;

/* Implementation of "app.core.gpu" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_3app_4core_3gpu_validate_gpu_access(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_roles, PyObject *__pyx_v_gpus); /* proto */
...
#define __pyx_kp_u_app_core_gpu_py __pyx_string_tab[3]
#define __pyx_kp_u_gpu_access_denied __pyx_string_tab[4]
#define __pyx_kp_u_gpu_allowed __pyx_string_tab[5]
#define __pyx_kp_u_no_gpu_needed __pyx_string_tab[6]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[7]
#define __pyx_n_u_app_core_gpu __pyx_string_tab[8]
...
#define __pyx_n_u_gpu_user __pyx_string_tab[12]
#define __pyx_n_u_gpus __pyx_string_tab[13]
...
#define __pyx_n_u_roles __pyx_string_tab[23]
...
#define __pyx_n_u_validate_gpu_access __pyx_string_tab[27]
#define __pyx_n_u_values __pyx_string_tab[28]
#define __pyx_kp_b_iso88591_1_uCq_vQ_wa_6 __pyx_string_tab[29]
...
/* Python wrapper */
static PyObject *__pyx_pw_3app_4core_3gpu_1validate_gpu_access(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_3app_4core_3gpu_1validate_gpu_access = {"validate_gpu_access", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_3app_4core_3gpu_1validate_gpu_access, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_3app_4core_3gpu_1validate_gpu_access(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("validate_gpu_access (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_roles,&__pyx_mstate_global->__pyx_n_u_gpus,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "validate_gpu_access", 0) < (0)) __PYX_ERR(0, 1, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("validate_gpu_access", 1, 2, 2, i); __PYX_ERR(0, 1, __pyx_L3_error) }
      }
    ...
    if (__Pyx_PyInt_FromNumber(&values[1], "gpus", 0) < (0)) __PYX_ERR(0, 1, __pyx_L3_error)
    __pyx_v_gpus = ((PyObject*)values[1]);
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("validate_gpu_access", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 1, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("app.core.gpu.validate_gpu_access", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_roles), (&PyList_Type), 0, "roles", 2))) __PYX_ERR(0, 1, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_gpus), (&PyLong_Type), 0, "gpus", 2))) __PYX_ERR(0, 1, __pyx_L1_error)
  __pyx_r = __pyx_pf_3app_4core_3gpu_validate_gpu_access(__pyx_self, __pyx_v_roles, __pyx_v_gpus);
...
static PyObject *__pyx_pf_3app_4core_3gpu_validate_gpu_access(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_roles, PyObject *__pyx_v_gpus) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("validate_gpu_access", 0);
 ...
 * 
*/
  __pyx_t_1 = PyObject_RichCompare(__pyx_v_gpus, __pyx_mstate_global->__pyx_int_0, Py_LE); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 3, __pyx_L1_error)
 ...
 * 
*/
  __pyx_t_2 = (__Pyx_PySequence_ContainsTF(__pyx_mstate_global->__pyx_n_u_gpu_user, __pyx_v_roles, Py_NE)); if (unlikely((__pyx_t_2 < 0))) __PYX_ERR(0, 6, __pyx_L1_error)
  if (__pyx_t_2) {
...
#endif
{
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "gpu" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_gpu", 0);
  ...
  if (__pyx_module_is_main_app__core__gpu) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "app.core.gpu")) {
      if (unlikely((PyDict_SetItemString(modules, "app.core.gpu", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_gpus, __pyx_mstate_global->__pyx_n_u_int) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  __pyx_t_3 = __Pyx_CyFunction_New(&__pyx_mdef_3app_4core_3gpu_1validate_gpu_access, 0, __pyx_mstate_global->__pyx_n_u_validate_gpu_access, NULL, __pyx_mstate_global->__pyx_n_u_app_core_gpu, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 1, __pyx_L1_error)
  ...
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_validate_gpu_access, __pyx_t_3) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init app.core.gpu", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init app.core.gpu");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
 ...
 *     if "gpu_user" not in roles:
*/
  __pyx_mstate_global->__pyx_tuple[0] = PyTuple_Pack(2, Py_True, __pyx_mstate_global->__pyx_kp_u_no_gpu_needed); if (unlikely(!__pyx_mstate_global->__pyx_tuple[0])) __PYX_ERR(0, 4, __pyx_L1_error)
 ...
 *     return True, "gpu allowed"
*/
  __pyx_mstate_global->__pyx_tuple[1] = PyTuple_Pack(2, Py_False, __pyx_mstate_global->__pyx_kp_u_gpu_access_denied); if (unlikely(!__pyx_mstate_global->__pyx_tuple[1])) __PYX_ERR(0, 7, __pyx_L1_error)
 ...
 *     return True, "gpu allowed"             # <<<<<<<<<<<<<<
*/
  __pyx_mstate_global->__pyx_tuple[2] = PyTuple_Pack(2, Py_True, __pyx_mstate_global->__pyx_kp_u_gpu_allowed); if (unlikely(!__pyx_mstate_global->__pyx_tuple[2])) __PYX_ERR(0, 9, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{1},{179},{8},{15},{17},{11},{13},{20},{12},{18},{18},{8},{8},{4},{3},{13},{5},{4},{8},{10},{8},{3},{12},{5},{12},{10},{8},{19},{6},{46}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (421 bytes) */
const char* const cstring = "BZh91AY&SY\307\345\206\025\000\000 \177\363D\310\240\000\300\203\245@\217!p\000\277\377\377\354@@@@\000@@@@\0000\001E\266\323\rFQ\246\246\246\332\247\265\032\236\324&\004\032=&G\251\214\215=M\250D\304\304\312\233S\004&\215\003@\000\001\246\200\rS\3215\036S4\322~\242z \000\000\000\000\035\363\210\"!\000\231\007{\327\363\316\272+\260e\335`\311\"\224\"?\310\256\210[\207\t\222\225/\356v\324\265\33110\312\037\033!F\311\216\211\214h\333Q\230m$\022\362C\222\034\333yHt%\3111I\322b3!r\t8)X;\336\274\033~\225\274\215\345\2615\353\266\377\220\206\272\333\351\241\3306\331_\020<!\023\207\330\341B\030\"\013!*X\227F\020E\220\341{f\023\323\002\232F\25718\234\365\216\321\224\205\2000\213\321\210\313\346\266\0059H\273\035\315\0310{\261\331\243\031\261\261\002{\214\245\236=TC\014p\304\362\345f\271\005e\030\036I\301\003\n\351%r\227q\223\222H\246\312\330\321\243\005\003\022\327-R$\221mu\351\204\314\005\320RU\022\324\007YA\256\033\000\017Ny\214\230\027A\315P\023B!\024\214k\236aJ\001\346Z\310h+&\231\210\363f\234\016)Q\026\021v\262\000/\212\203*\002\3443<\002\004\003\354T\037\177Lr;8\177\033\333\235\006\353\353T\253\236\220\370\346\256\321\321\312\352\037~\352\267\276\r\323\312\370j\360.\344\212p\241!\217\313\014*";
    PyObject *data = __Pyx_DecompressString(cstring, 421, 2);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (361 bytes) */
const char* const cstring = "x\332MQ=N\2341\020M\201\224H)\"N\300t[\345CH(\242\243 \211\224\006mr\201\321\254=\313\016x\355\017\317x\341SRPn\271%G\310qRRr\024\306\020!,y<o\374\336\374\330\247\347\305\030lE\006g\223\255J\006Q\210\234d\301\225\214\323\004jU\202q\355\244\014\363o\363\317\307'\307@9B\345K\016\246\240m\021\022\251\262BY\302\242I2\311`\323\310:\300\217%L\245Af\216`\005F\347\275\025\330\2123([w`F9\027#\223\222\321\345\222/f\020\245z\021\331pW\177\247\244<P\214\350<\246q<\014\245\362\341\305\330\206qr\013\024\002k\037 \013\307\347@J\345\206c.\320Q\357\202#\342|\272\365\375\325\347\302s\276\265_\274\364\\C\31758\215t\312AJ\307\245\371(\254!\271E\361\256*\005^P\270B\\\266\034\020\235\216M\271\372\251\222\rE\361U&\306kM\242\206\270&\027\373Z\227\330\022w/\323\332\317\261\214\210\327\215\322\013\254%\261\"\372{\374\277w/zs-y\016\343\236iCI\242\377\314s\345\227q=\324X\377\275;\270\377\363\367\350q\357\375]\333\236m\257\037>|\332nv?;\376\275\233\335\357w|\263\243\307\275\217\333/\273\375'C\023\302\216";
    PyObject *data = __Pyx_DecompressString(cstring, 361, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
...
const char* const bytes = "?Note that Cython is deliberately stricter than PEP-484 and rejects subclasses of builtin types. If you need to pass subclasses then set the 'annotation_typing' directive to False.add_noteapp/core/gpu.pygpu access deniedgpu allowedno gpu needed__Pyx_PyDict_NextRefapp.core.gpuasyncio.coroutinescline_in_traceback__func__gpu_usergpusint_is_coroutineitemslist__main____module____name__pop__qualname__roles__set_name__setdefault__test__validate_gpu_accessvalues\320\000\037\230|\2501\340\004\007\200u\210C\210q\330\010\017\210v\220Q\340\004\007\200{\220'\230\021\330\010\017\210w\220a\340\004\013\2106\220\021";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_roles, __pyx_mstate->__pyx_n_u_gpus};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_app_core_gpu_py, __pyx_mstate->__pyx_n_u_validate_gpu_access, __pyx_mstate->__pyx_kp_b_iso88591_1_uCq_vQ_wa_6, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
