...
#define __PYX_HAVE__app__core__quota
#define __PYX_HAVE_API__app__core__quota
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "app.core.quota" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "app.core.quota"
extern int __pyx_module_is_main_app__core__quota;
int __pyx_module_is_main_app__core__quota = 0;

/* Implementation of "app.core.quota" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_3app_4core_5quota_evaluate_quota(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_current_cpu, double __pyx_v_current_gpu, double __pyx_v_request_cpu, double __pyx_v_request_gpu); /* proto */
...
#define __pyx_kp_u_app_core_quota_py __pyx_string_tab[2]
#define __pyx_kp_u_cpu_quota_exceeded __pyx_string_tab[3]
#define __pyx_kp_u_gpu_quota_exceeded __pyx_string_tab[4]
#define __pyx_kp_u_quota_ok __pyx_string_tab[5]
#define __pyx_n_u_Config __pyx_string_tab[6]
#define __pyx_n_u_DEFAULT_CPU_HOURS __pyx_string_tab[7]
#define __pyx_n_u_DEFAULT_GPU_HOURS __pyx_string_tab[8]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[9]
#define __pyx_n_u_app_core_config __pyx_string_tab[10]
#define __pyx_n_u_app_core_quota __pyx_string_tab[11]
#define __pyx_n_u_asyncio_coroutines __pyx_string_tab[12]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[13]
#define __pyx_n_u_current_cpu __pyx_string_tab[14]
#define __pyx_n_u_current_gpu __pyx_string_tab[15]
#define __pyx_n_u_evaluate_quota __pyx_string_tab[16]
#define __pyx_n_u_float __pyx_string_tab[17]
...
#define __pyx_n_u_remaining_cpu __pyx_string_tab[26]
#define __pyx_n_u_remaining_gpu __pyx_string_tab[27]
#define __pyx_n_u_request_cpu __pyx_string_tab[28]
#define __pyx_n_u_request_gpu __pyx_string_tab[29]
...
#define __pyx_kp_b_iso88591_F_Rq_F_Rq_2Q_w_O1_2Q_w_O1_6__A __pyx_string_tab[34]
...
/* Python wrapper */
static PyObject *__pyx_pw_3app_4core_5quota_1evaluate_quota(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_3app_4core_5quota_1evaluate_quota = {"evaluate_quota", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_3app_4core_5quota_1evaluate_quota, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_3app_4core_5quota_1evaluate_quota(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  double __pyx_v_current_cpu;
  double __pyx_v_current_gpu;
  double __pyx_v_request_cpu;
  double __pyx_v_request_gpu;
  #if !CYTHON_METH_FASTCALL
  ...
  __Pyx_RefNannySetupContext("evaluate_quota (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_current_cpu,&__pyx_mstate_global->__pyx_n_u_current_gpu,&__pyx_mstate_global->__pyx_n_u_request_cpu,&__pyx_mstate_global->__pyx_n_u_request_gpu,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "evaluate_quota", 0) < (0)) __PYX_ERR(0, 4, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 4; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("evaluate_quota", 1, 4, 4, i); __PYX_ERR(0, 4, __pyx_L3_error) }
      }
    ...
    __pyx_v_current_cpu = __Pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_current_cpu == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_current_gpu = __Pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_current_gpu == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_request_cpu = __Pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_request_cpu == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 7, __pyx_L3_error)
    __pyx_v_request_gpu = __Pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_request_gpu == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("evaluate_quota", 1, 4, 4, __pyx_nargs); __PYX_ERR(0, 4, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("app.core.quota.evaluate_quota", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3app_4core_5quota_evaluate_quota(__pyx_self, __pyx_v_current_cpu, __pyx_v_current_gpu, __pyx_v_request_cpu, __pyx_v_request_gpu);
...
static PyObject *__pyx_pf_3app_4core_5quota_evaluate_quota(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_current_cpu, double __pyx_v_current_gpu, double __pyx_v_request_cpu, double __pyx_v_request_gpu) {
  PyObject *__pyx_v_remaining_cpu = NULL;
  PyObject *__pyx_v_remaining_gpu = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("evaluate_quota", 0);

  /* "app/core/quota.py":11
 * ):
 * 
 ...
 * 
*/
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_mstate_global->__pyx_n_u_Config); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_mstate_global->__pyx_n_u_DEFAULT_CPU_HOURS); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_current_cpu); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyNumber_Subtract(__pyx_t_2, __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_remaining_cpu = __pyx_t_3;
  __pyx_t_3 = 0;

  /* "app/core/quota.py":12
 * 
 *     remaining_cpu = Config.DEFAULT_CPU_HOURS - current_cpu
 *     remaining_gpu = Config.DEFAULT_GPU_HOURS - current_gpu             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_DEFAULT_GPU_HOURS); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyFloat_FromDouble(__pyx_v_current_gpu); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = PyNumber_Subtract(__pyx_t_1, __pyx_t_3); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_remaining_gpu = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "app/core/quota.py":14
 *     remaining_gpu = Config.DEFAULT_GPU_HOURS - current_gpu
 * 
 *     if request_cpu > remaining_cpu:             # <<<<<<<<<<<<<<
 ...
 * 
*/
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_request_cpu); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyObject_RichCompare(__pyx_t_2, __pyx_v_remaining_cpu, Py_GT); __Pyx_XGOTREF(__pyx_t_3); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_4 = __Pyx_PyObject_IsTrue(__pyx_t_3); if (unlikely((__pyx_t_4 < 0))) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (__pyx_t_4) {

    /* "app/core/quota.py":15
 * 
 *     if request_cpu > remaining_cpu:
 *         return False, "cpu quota exceeded", remaining_cpu, remaining_gpu             # <<<<<<<<<<<<<<
 * 
...
*/
    ...
    if (__Pyx_PyTuple_SET_ITEM(__pyx_t_3, 0, Py_False) != (0)) __PYX_ERR(0, 15, __pyx_L1_error);
    __Pyx_INCREF(__pyx_mstate_global->__pyx_kp_u_cpu_quota_exceeded);
    __Pyx_GIVEREF(__pyx_mstate_global->__pyx_kp_u_cpu_quota_exceeded);
    if (__Pyx_PyTuple_SET_ITEM(__pyx_t_3, 1, __pyx_mstate_global->__pyx_kp_u_cpu_quota_exceeded) != (0)) __PYX_ERR(0, 15, __pyx_L1_error);
    __Pyx_INCREF(__pyx_v_remaining_cpu);
    __Pyx_GIVEREF(__pyx_v_remaining_cpu);
    if (__Pyx_PyTuple_SET_ITEM(__pyx_t_3, 2, __pyx_v_remaining_cpu) != (0)) __PYX_ERR(0, 15, __pyx_L1_error);
    __Pyx_INCREF(__pyx_v_remaining_gpu);
    __Pyx_GIVEREF(__pyx_v_remaining_gpu);
    if (__Pyx_PyTuple_SET_ITEM(__pyx_t_3, 3, __pyx_v_remaining_gpu) != (0)) __PYX_ERR(0, 15, __pyx_L1_error);
    __pyx_r = __pyx_t_3;
    __pyx_t_3 = 0;
    goto __pyx_L0;
 ...
 * 
*/
  __pyx_t_3 = PyFloat_FromDouble(__pyx_v_request_gpu); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = PyObject_RichCompare(__pyx_t_3, __pyx_v_remaining_gpu, Py_GT); __Pyx_XGOTREF(__pyx_t_2); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_4 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely((__pyx_t_4 < 0))) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (__pyx_t_4) {

    /* "app/core/quota.py":18
 * 
 *     if request_gpu > remaining_gpu:
 *         return False, "gpu quota exceeded", remaining_cpu, remaining_gpu             # <<<<<<<<<<<<<<
 * 
...
*/
    ...
    __Pyx_INCREF(Py_False);
    __Pyx_GIVEREF(Py_False);
    if (__Pyx_PyTuple_SET_ITEM(__pyx_t_2, 0, Py_False) != (0)) __PYX_ERR(0, 18, __pyx_L1_error);
    __Pyx_INCREF(__pyx_mstate_global->__pyx_kp_u_gpu_quota_exceeded);
    __Pyx_GIVEREF(__pyx_mstate_global->__pyx_kp_u_gpu_quota_exceeded);
    if (__Pyx_PyTuple_SET_ITEM(__pyx_t_2, 1, __pyx_mstate_global->__pyx_kp_u_gpu_quota_exceeded) != (0)) __PYX_ERR(0, 18, __pyx_L1_error);
    __Pyx_INCREF(__pyx_v_remaining_cpu);
    __Pyx_GIVEREF(__pyx_v_remaining_cpu);
    if (__Pyx_PyTuple_SET_ITEM(__pyx_t_2, 2, __pyx_v_remaining_cpu) != (0)) __PYX_ERR(0, 18, __pyx_L1_error);
    __Pyx_INCREF(__pyx_v_remaining_gpu);
    __Pyx_GIVEREF(__pyx_v_remaining_gpu);
    if (__Pyx_PyTuple_SET_ITEM(__pyx_t_2, 3, __pyx_v_remaining_gpu) != (0)) __PYX_ERR(0, 18, __pyx_L1_error);
    __pyx_r = __pyx_t_2;
    __pyx_t_2 = 0;
    goto __pyx_L0;
...
*/
  ...
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_2, 0, Py_True) != (0)) __PYX_ERR(0, 20, __pyx_L1_error);
  __Pyx_INCREF(__pyx_mstate_global->__pyx_kp_u_quota_ok);
  __Pyx_GIVEREF(__pyx_mstate_global->__pyx_kp_u_quota_ok);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_2, 1, __pyx_mstate_global->__pyx_kp_u_quota_ok) != (0)) __PYX_ERR(0, 20, __pyx_L1_error);
  __Pyx_INCREF(__pyx_v_remaining_cpu);
  __Pyx_GIVEREF(__pyx_v_remaining_cpu);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_2, 2, __pyx_v_remaining_cpu) != (0)) __PYX_ERR(0, 20, __pyx_L1_error);
  __Pyx_INCREF(__pyx_v_remaining_gpu);
  __Pyx_GIVEREF(__pyx_v_remaining_gpu);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_2, 3, __pyx_v_remaining_gpu) != (0)) __PYX_ERR(0, 20, __pyx_L1_error);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
...
*/
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_remaining_cpu);
  __Pyx_XDECREF(__pyx_v_remaining_gpu);
...
static int __pyx_pymod_exec_quota(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_quota},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_quota(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_quota(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_quota(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'quota' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "quota" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_quota", 0);
  ...
  if (__pyx_module_is_main_app__core__quota) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "app.core.quota")) {
      if (unlikely((PyDict_SetItemString(modules, "app.core.quota", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  {
    ...
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_app_core_config, __pyx_imported_names, 1, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
 ...
 *     current_gpu: float,
*/
  __pyx_t_2 = __Pyx_PyDict_NewPresized(4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_current_cpu, __pyx_mstate_global->__pyx_n_u_float) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_current_gpu, __pyx_mstate_global->__pyx_n_u_float) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_request_cpu, __pyx_mstate_global->__pyx_n_u_float) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_request_gpu, __pyx_mstate_global->__pyx_n_u_float) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
  __pyx_t_4 = __Pyx_CyFunction_New(&__pyx_mdef_3app_4core_5quota_1evaluate_quota, 0, __pyx_mstate_global->__pyx_n_u_evaluate_quota, NULL, __pyx_mstate_global->__pyx_n_u_app_core_quota, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_evaluate_quota, __pyx_t_4) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init app.core.quota", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init app.core.quota");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{1},{17},{18},{18},{8},{6},{17},{17},{20},{15},{14},{18},{18},{11},{11},{14},{5},{8},{13},{5},{8},{10},{8},{3},{12},{13},{13},{11},{11},{12},{10},{8},{6},{93}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (386 bytes) */
const char* const cstring = "BZh91AY&SY\360\335\275y\000\000\024\377\373\347\310\267\024@\007\261\000\257\305\376\000\277\257\377\344@@@@\000@\000@@@@\000@\0000\001:\261XJ\244\r\032h\0004\032\000\000\007\250\014\215\003M2z\203BS\362FS)\355'\251\r\r\000z\200\000\000\0001\001*z\247\244Bz\217D\320\321\264!\202\000\006M\r\r4\364\001\243\373I\266\273l3\321\030Q\220\004\200\321\316\032\375\0351X\345.{\3442PfS\224\215\227\223\240a\316\334\240\326l\027#\250\321\t\002\346\344E\025\025\036Th\3420s:\013\r\213\024\266=\325Q\236_\350\237\251\366\225\305\010\365]D\210\036\303\"\004