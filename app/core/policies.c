...
{
    "distutils": {
        "name": "app.core.policies",
        "sources": [
            "app/core/policies.py"
        ]
    },
    "module_name": "app.core.policies"
}
END: Cython Metadata */
...
#define __PYX_HAVE__app__core__policies
#define __PYX_HAVE_API__app__core__policies
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "app.core.policies" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "app.core.policies"
extern int __pyx_module_is_main_app__core__policies;
int __pyx_module_is_main_app__core__policies = 0;

/* Implementation of "app.core.policies" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_3app_4core_8policies_validate_partition_access(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_roles, PyObject *__pyx_v_partition); /* proto */
...
#define __pyx_kp_u_app_core_policies_py __pyx_string_tab[3]
#define __pyx_kp_u_dgx_a100 __pyx_string_tab[4]
#define __pyx_kp_u_dgx_partition_denied __pyx_string_tab[5]
#define __pyx_kp_u_partition_allowed __pyx_string_tab[6]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[7]
#define __pyx_n_u_app_core_policies __pyx_string_tab[8]
#define __pyx_n_u_asyncio_coroutines __pyx_string_tab[9]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[10]
#define __pyx_n_u_dgx_access __pyx_string_tab[11]
...
#define __pyx_n_u_partition __pyx_string_tab[19]
#define __pyx_n_u_pop __pyx_string_tab[20]
#define __pyx_n_u_qualname __pyx_string_tab[21]
#define __pyx_n_u_roles __pyx_string_tab[22]
...
#define __pyx_n_u_validate_partition_access __pyx_string_tab[27]
#define __pyx_n_u_values __pyx_string_tab[28]
#define __pyx_kp_b_iso88591_6a_z_A_q_7_6 __pyx_string_tab[29]
...
/* Python wrapper */
static PyObject *__pyx_pw_3app_4core_8policies_1validate_partition_access(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_3app_4core_8policies_1validate_partition_access = {"validate_partition_access", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_3app_4core_8policies_1validate_partition_access, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_3app_4core_8policies_1validate_partition_access(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("validate_partition_access (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_roles,&__pyx_mstate_global->__pyx_n_u_partition,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "validate_partition_access", 0) < (0)) __PYX_ERR(0, 1, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("validate_partition_access", 1, 2, 2, i); __PYX_ERR(0, 1, __pyx_L3_error) }
      }
    ...
    __pyx_v_partition = ((PyObject*)values[1]);
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("validate_partition_access", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 1, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("app.core.policies.validate_partition_access", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_roles), (&PyList_Type), 0, "roles", 2))) __PYX_ERR(0, 1, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_partition), (&PyUnicode_Type), 0, "partition", 2))) __PYX_ERR(0, 1, __pyx_L1_error)
  __pyx_r = __pyx_pf_3app_4core_8policies_validate_partition_access(__pyx_self, __pyx_v_roles, __pyx_v_partition);
...
static PyObject *__pyx_pf_3app_4core_8policies_validate_partition_access(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_roles, PyObject *__pyx_v_partition) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("validate_partition_access", 0);

  /* "app/core/policies.py":3
 * def validate_partition_access(roles: list, partition: str):
 * 
 *     if partition == "dgx-a100":             # <<<<<<<<<<<<<<
...
*/
  __pyx_t_1 = (__Pyx_PyUnicode_Equals(__pyx_v_partition, __pyx_mstate_global->__pyx_kp_u_dgx_a100, Py_EQ)); if (unlikely((__pyx_t_1 < 0))) __PYX_ERR(0, 3, __pyx_L1_error)
  if (__pyx_t_1) {

    /* "app/core/policies.py":4
 * 
 *     if partition == "dgx-a100":
 *         if "dgx_access" not in roles:             # <<<<<<<<<<<<<<
 *             return False, "dgx partition denied"
 * 
*/
    __pyx_t_1 = (__Pyx_PySequence_ContainsTF(__pyx_mstate_global->__pyx_n_u_dgx_access, __pyx_v_roles, Py_NE)); if (unlikely((__pyx_t_1 < 0))) __PYX_ERR(0, 4, __pyx_L1_error)
    if (__pyx_t_1) {

      /* "app/core/policies.py":5
 *     if partition == "dgx-a100":
 *         if "dgx_access" not in roles:
 *             return False, "dgx partition denied"             # <<<<<<<<<<<<<<
 * 
...
#endif
{
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "policies" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_policies", 0);
  ...
  if (__pyx_module_is_main_app__core__policies) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "app.core.policies")) {
      if (unlikely((PyDict_SetItemString(modules, "app.core.policies", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_roles, __pyx_mstate_global->__pyx_n_u_list) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_partition, __pyx_mstate_global->__pyx_n_u_str) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  __pyx_t_3 = __Pyx_CyFunction_New(&__pyx_mdef_3app_4core_8policies_1validate_partition_access, 0, __pyx_mstate_global->__pyx_n_u_validate_partition_access, NULL, __pyx_mstate_global->__pyx_n_u_app_core_policies, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 1, __pyx_L1_error)
  ...
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_validate_partition_access, __pyx_t_3) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init app.core.policies", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init app.core.policies");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
 ...
 *     return True, "partition allowed"
*/
  __pyx_mstate_global->__pyx_tuple[0] = PyTuple_Pack(2, Py_False, __pyx_mstate_global->__pyx_kp_u_dgx_partition_denied); if (unlikely(!__pyx_mstate_global->__pyx_tuple[0])) __PYX_ERR(0, 5, __pyx_L1_error)
 ...
 *